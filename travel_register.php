					...
					<div class="row animate-box">
						...
						<div class="col-md-12">
							...
							<form method="POST" enctype="multipart/form-data">
								...
								<div class="control-group">
									<input type="text" class="form-control p-4" name="location" placeholder="Location" required="required" data-validation-required-message="Please enter a subject" />
									<p class="help-block text-danger"></p>
								</div>
								<div class="control-group">
	  ...
	  if(isset($_POST['submit']))
	  {
		  ...
		  if(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) {
			  ...
			  $img=basename( $_FILES['uploadedfile']['name']);
				...
				$ins="insert into travels(name,email,phone,password,document,location,status) values('$name','$email','$phone','$password','$img','$location','pending')";
				  //echo $ins;
				...
				echo '<script>alert("Registration failed!")
					  window.location="travel_register.php";
					  </script>';
			}
